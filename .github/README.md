...
[`@aws-sdk/client-partnercentral-account`](https://www.npmjs.com/package/@aws-sdk/client-partnercentral-account/v/3.1113.0).
...
- @aws-sdk/client-partnercentral-account v3.1113.0 - [https://cloud-sdk-builds.github.io/?sdk=client-partnercentral-account&version=3.1113.0](https://cloud-sdk-builds.github.io/?sdk=client-partnercentral-account&version=3.1113.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-partnercentral-account@3.1113.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kcHqFT3XyZBFhuF/tDBjC+K/3K1dy3oukUKXNRO4tCWbuk+tqpNG3jioUPN0/dMN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-partnercentral-account": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-partnercentral-account@3.1113.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-partnercentral-account@3.1113.0/index.min.mjs": "sha384-kcHqFT3XyZBFhuF/tDBjC+K/3K1dy3oukUKXNRO4tCWbuk+tqpNG3jioUPN0/dMN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-partnercentral-account/blob/refs/tags/3.1113.0/LICENSE
```
